...
<head>
    ...
    <title>My Leaves - HR Management</title>
...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item active" href="#">My Leaves</a></li>
    ...
    <div class="main-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 d-none d-lg-flex">
            <h2><i class="bi bi-journal-text text-primary"></i> My Leave Requests</h2>
                ...
                <div class="card leave-balance-card">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h4 class="mb-0"><i class="bi bi-wallet2 me-2"></i>Leave Balance</h4>
                            <button type="button" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#requestLeaveModal">
                                <i class="bi bi-plus-circle"></i> Request Leave
                            </button>
                        </div>
                        <div class="row text-center">
                            <div class="col-md-3 mb-3 mb-md-0">
                                <h5 class="mb-1">Annual Leave</h5>
                            ...
                            <div class="col-md-3 mb-3 mb-md-0">
                                <h5 class="mb-1">Sick Leave</h5>
                                <h3 class="mb-0">5/10</h3>
                                <div class="progress mt-2" style="height: 8px;">
                                    <div class="progress-bar bg-light" role="progressbar" style="width: 50%"></div>
                                </div>
                            </div>
                            <div class="col-md-3 mb-3 mb-md-0">
                                <h5 class="mb-1">Casual Leave</h5>
                            ...
                            <div class="col-md-3">
                                <h5 class="mb-1">Maternity Leave</h5>
                                <h3 class="mb-0">0/12</h3>
                                <div class="progress mt-2" style="height: 8px;">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h5><i class="bi bi-plus-circle"></i> Request New Leave</h5>
                    </div>
                    <div class="card-body">
                        <form>
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="reason" placeholder="e.g., Medical Appointment" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="description" rows="3" placeholder="Provide details about your leave request..."></textarea>
                            </div>
                ...
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5><i class="bi bi-clock-history"></i> Leave History</h5>
                            <div class="d-flex">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>LV-00098</td>
                                        <td>Annual Leave</td>
                                        <td>2024-02-15 to 2024-02-20</td>
                                        <td>6</td>
                                        <td>Family Trip</td>
                                        <td>2024-02-01</td>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="modalReason" placeholder="e.g., Medical Appointment" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="modalDescription" rows="3" placeholder="Provide details about your leave request..."></textarea>
                        </div>
                        
                        <div class="mb-3">
                            <label for="modalAttachment" class="form-label">Attachment (Optional)</label>
                            <input type="file" class="form-control" id="modalAttachment">
                        </div>
                    </div>
