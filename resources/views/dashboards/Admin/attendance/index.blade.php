    ...
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item active" href="{{ route('hrm.attendance.admin.index') }}">Admin Attendance</a></li>
        ...
        <div class="row g-3 g-md-4">
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5><i class="bi bi-table"></i> Attendance Records - {{ date('F j, Y') }}</h5>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="https://ui-avatars.com/api/?name=Emma+Johnson&background=0D8ABC&color=fff" class="rounded-circle me-2" width="30" height="30">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="https://ui-avatars.com/api/?name=Robert+Brown&background=0D8ABC&color=fff" class="rounded-circle me-2" width="30" height="30">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="https://ui-avatars.com/api/?name=Lisa+Wilson&background=0D8ABC&color=fff" class="rounded-circle me-2" width="30" height="30">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="https://ui-avatars.com/api/?name=David+Miller&background=0D8ABC&color=fff" class="rounded-circle me-2" width="30" height="30">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="https://ui-avatars.com/api/?name=Jennifer+Taylor&background=0D8ABC&color=fff" class="rounded-circle me-2" width="30" height="30">
                ...
                <form>
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="attendanceNotes" rows="3" placeholder="Any additional notes..."></textarea>
                        </div>
                    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelector('.btn-warning').addEventListener('click', function() {
                var manualAttendanceModal = new bootstrap.Modal(document.getElementById('manualAttendanceModal'));
