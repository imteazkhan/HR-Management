...
<body>
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item active" href="{{ route('hrm.loans.personal.index') }}">Personal Loan</a></li>
                </ul>
            </li>
    ...
    <div class="main-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 d-none d-lg-flex">
            <h2><i class="bi bi-cash-stack text-primary"></i> Personal Loan Management</h2>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        <a href="{{ route('hrm.loans.personal.create') }}" class="btn btn-warning">
        ...
        <div class="row g-3 g-md-4">
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5><i class="bi bi-table"></i> Personal Loan Records</h5>
                            <span class="badge bg-light text-dark">Showing 10 of 42 records</span>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <!-- Pagination -->
                        <nav aria-label="Loan records pagination">
